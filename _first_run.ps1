...
Copy-FileIfMissing -Path 'src\templates\secure.template.ts' -Destination 'src\_configs\secure.ts'
...
Rename-InternalNames -Path 'src\_configs\secure.ts' -Name 'KeysTemplate.' -NewName 'Keys.'
