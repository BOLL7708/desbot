...
Copy-FileIfMissing -Path 'templates\settings_twitch_tokens.template.csv' -Destination '_settings\settings_twitch_tokens.csv'
Copy-FileIfMissing -Path 'src\templates\config.template.ts' -Destination 'src\_configs\config.base.ts'
Copy-FileIfMissing -Path 'src\templates\secure.template.ts' -Destination 'src\_configs\secure.base.ts'
...
Rename-InternalNames -Path 'src\_configs\secure.base.ts' -Name 'KeysTemplate.' -NewName 'Keys.'
Rename-InternalNames -Path 'src\_configs\config.base.ts' -Name 'KeysTemplate.' -NewName 'Keys.'
Rename-InternalNames -Path 'src\_configs\config.base.ts' -Name 'ControllerPresetsTemplate.' -NewName 'ControllerPresets.'
Rename-InternalNames -Path 'src\_configs\config.base.ts' -Name 'GamesTemplate.' -NewName 'Games.'
Rename-InternalNames -Path 'src\_configs\config.base.ts' -Name 'GamePresetsTemplate.' -NewName 'GamePresets.'
Rename-InternalNames -Path 'src\_configs\config.base.ts' -Name 'PipePresetsTemplate.' -NewName 'PipePresets.'
