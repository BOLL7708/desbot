...
Copy-FileIfMissing -Path 'src\templates\config+events.template.ts' -Destination 'src\_configs\config+events.ts'
...
Rename-InternalNames -Path 'src\_data\!keys.ts' -Name 'TKeysTemplate' -NewName 'TKeys'
