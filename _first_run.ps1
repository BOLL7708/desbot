...
Rename-InternalNames -Path 'src\_configs\config+commands.ts' -Name 'KeysTemplate.' -NewName 'Keys.'
Rename-InternalNames -Path 'src\_configs\config+rewards.ts' -Name 'KeysTemplate.' -NewName 'Keys.'
