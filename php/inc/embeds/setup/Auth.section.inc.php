<div id="sectionRegister">
    <h2>Register</h2>
    <p>To prevent anonymous access to this solution, please set a password.</p>
    <form id="formRegister">
        <p><label>Password: <input type="password" name="password"/></label> <input type="submit" value="Save"/></p>
    </form>
</div>
<div id="sectionLogin">
    <h2>Authenticate</h2>
