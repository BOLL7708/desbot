...
import DataBaseHelper, {IDataBaseItem} from '../../../Shared/Helpers/DataBaseHelper.mts'
import DataMap, {IRootTool} from '../../../Shared/Objects/Data/DataMap.mts'
import Constants from '../../../Shared/Constants/Constants.mts'
...
import EditorHandlerUtils from './EditorHandlerUtils.mts'
import JsonEditor from './JsonEditor.mts'
...
export default class EditorHandler {
    ...
    private async buildEditorControls(
        ...
        editorimportButton.title = 'Import the current system clipboard.mtsON data into the editor.'
        editorImportButton.onclick = async (event)=>{
            const result = await Utils.readFromClipboard(true)
            if(!result) alert('Unable to import, clipboard unavailable or contains invalid.mtsON data.')
