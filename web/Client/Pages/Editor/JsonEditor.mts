import DataMeta from '../../../Shared/Objects/Data/DataMeta.mts'
import AbstractData, {EmptyData} from '../../../Shared/Objects/Data/AbstractData.mts'
import DataBaseHelper, {IDataBaseItem, IDataBaseListItems} from '../../../Shared/Helpers/DataBaseHelper.mts'
import EditorBus from './EditorBus.mts'
import Utils, {EUtilsTitleReturnOption} from '../../../Shared/Utils/Utils.mts'
import DataMap, {TRootToolResponseData} from '../../../Shared/Objects/Data/DataMap.mts'
import DataUtils from '../../../Shared/Objects/Data/DataUtils.mts'
import {JsonEditorUtils} from './JsonEditorUtils.mts'
import OptionsMap from '../../../Shared/Objects/Options/OptionsMap.mts'
import AssetsHelper from '../../../Shared/Helpers/AssetsHelper.mts'
import ConfigEditor, {ConfigEditorFavorite} from '../../../Shared/Objects/Data/Config/ConfigEditor.mts'
    ...
    private async buildField(
        ...
        async function updatePreview(config: ConfigEditor) {
            ...
            if(thisTypeValues.file.length || parentTypeValues.file.length) {
                value = AssetsHelper.rootPath+value
